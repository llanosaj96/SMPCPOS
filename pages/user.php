        ...
        <!-- ADMIN TABLE -->
         <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 style="color: green;">Admin Account(s)</h4>
            </div>
            <div class="card-body">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['TYPE'].'</td>';
                      echo '<td align="right"> <div class="btn-group">
                              <a type="button" style="background: green; border-color: green; color: white;" class="btn btn-primary bg-gradient-primary" href="us_searchfrm.php?action=edit & id='.$row['ID'] . '"><i class="fas fa-fw fa-list-alt"></i> Details</a>
                            <div class="btn-group">
...
?>         
         ...
         <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h4 style="color: green;">User Accounts&nbsp;<a  href="#" style="border-radius: 7px; background: green; border-color: green; color: white;" data-toggle="modal" data-target="#supplierModal" type="button" class="btn btn-primary bg-gradient-primary" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a></h4>
            </div>
            <div class="card-body">
            <div class="table-responsive">
           <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
