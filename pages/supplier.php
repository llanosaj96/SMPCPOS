...
<?php
            ...
            <div class="card-header py-3">
              <h4 style="color: green;">Supplier&nbsp;<a  href="#" data-toggle="modal" data-target="#supplierModal" type="button" class="btn btn-primary bg-gradient-primary" style="border-radius: 0px; border-radius: 7px; background: green; border-color: green; color: white;"><i class="fas fa-fw fa-plus"></i></a></h4>
            </div>
            <div class="card-body">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>'. $row['PHONE_NUMBER'].'</td>';
                      echo '<td align="right"> <div class="btn-group">
                              <a type="button" style=" background: green; border-color: green; color: white;" class="btn btn-primary bg-gradient-primary" href="sup_searchfrm.php?action=edit & id='.$row['SUPPLIER_ID'] . '"><i class="fas fa-fw fa-list-alt"></i> Details</a>
                            <div class="btn-group">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="sup_transac.php?action=add">
              ...
              <div class="form-group">
                <input class="form-control" placeholder="Phone Number" autocomplete="off" name="phonenumber" required>
              </div>
            <hr>
