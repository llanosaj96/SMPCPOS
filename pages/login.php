...
<head>
  ...
  <title> SMPC - Sales And Inventory</title>
...
<body class="bg-gradient-primary" style="background: green;">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row shadow">
              <div class="col-lg-6 "> <center> <img src="../img/smpclogo.png" style="margin-top: 20%;"> </center> </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" role="form" action="processlogin.php" method="post">
                    ...
                    <button class="btn btn-primary btn-user btn-block" style="background: green; border: none;" type="submit" name="btnlogin">Login</button>
                    <hr>
                  <!-- <div class="text-center">
