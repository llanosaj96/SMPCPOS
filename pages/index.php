...
if ($Aa=='User'){
          ...
          <div class="row show-grid">
            ...
            <!-- Product record -->
            <label>Notes:</label>
              <textarea id="notes" onkeyup="notes_now()" style="width: 500px; height: 200px; font-size: 12px;">
              <?php include'../includes/connection.php'; $sqll = mysqli_query($db, "SELECT * FROM notes "); while ($row = mysqli_fetch_assoc($sqll)) {
                $not = $row['NOTES'];
                echo $not;
              } ?>
              </textarea>
                      ...
                      <div class="card-body">
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                              <?php 
                                $query = "SELECT DISTINCT NAME FROM product order by PRODUCT_ID DESC LIMIT 10";
                                $result = mysqli_query($db, $query) or die(mysqli_error($db));
                                while ($row = mysqli_fetch_array($result)) {
