      ...
      <div class="row">
          <?php 
            ...
            $rec = @$_POST['recordNo'];
            $query = "SELECT * FROM product WHERE DELIVERY_QTY !=0 AND REF_ID='$rec'  GROUP BY PRODUCT_CODE ORDER by PRODUCT_CODE ASC";
            ...
            if ($result):
                if(mysqli_num_rows($result)>0):
                    while($product = mysqli_fetch_assoc($result)):
                      $on_hand1 = $product['DELIVERY_QTY'];
                      $ret = $product['DELIVERY_RETURNED'];
                      $on_hand = $on_hand1;
        ...
        <div class="col-sm-4 col-md-2" >
          <form method="post" id="submit_frm" action="pos.php?action=add&id=<?php echo $product['PRODUCT_ID']; ?>">
              <div class="products">
                  ...
                  <input type="submit" name="addpos_delivery" id="btn_addpos" style="margin-top:5px; width: 100%;" class="btn btn-info"
                         value="ADD" />
