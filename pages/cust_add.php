...
if ($Aa=='User'){
                        ...
                        <form role="form" method="post" action="cust_transac.php?action=add">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
              <label>Avail P.O ?</label>
              <select class="form-control" name="po_avail" id="po_avail">
            ...
            <div class="form-group">
              <input class="form-control" type="date" name="pos_date" id="pos_date" style="display: none;" required>
            </div>
                            <hr>
